...
public partial class AccountInformationForm : System.Web.UI.Page
{
    ...
    //Session["Test"].ToString(); //going to set labels using this session variable for the user email
    protected void Page_Load(object sender, EventArgs e)
    {

        connection.Open();

        string cmd = "select * from employer where companyemail = '" + "cole@dukes.com" + "';"; //use session variable irl: rn just testing w cole
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            //not showing any password or security question stuff
