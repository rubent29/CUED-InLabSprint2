...
public partial class FreeJobPostingForm : System.Web.UI.Page
{ 
...
protected void Populate_Button_Click(object sender, EventArgs e)
    {
        JobTitle.Text = "IT Intern";
        JobType.SelectedValue = "Full-TIme";
        City.Text = "Harrisonburg";
        State.Text = "VA";
        PayStatus.SelectedValue = "UnPaid";
        JobDescription.Text = "Creating Information Systems in C#";
        Deadline.Text = "04/15/2019";
        MinAge.Text = "18";
        MinGPA.Text = "3.2";
    }
